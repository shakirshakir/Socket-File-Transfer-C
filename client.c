/*	client.c file
	...
	Members: 1) Muhammad Shakir Zufayri  1092701243
...
if(argc <= 1){
printf("Error!! Please Include The Server IP Address [For example: ./client 127.0.0.1]\n", argv[0]); exit(1); }
...
else if(!strcmp(buffer, "2"))
{
	...
	printf("\nPlease Enter a FileName with the File Extension.\n");
